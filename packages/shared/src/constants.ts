...
export const TRANSPORT_PROTOCOL_VERSION: TransportProtocolVersion = 2;
export const DEFAULT_TRANSPORT_CONFIG_ID: SupportedTransportConfigId = "ghostscript-openai-v2";
